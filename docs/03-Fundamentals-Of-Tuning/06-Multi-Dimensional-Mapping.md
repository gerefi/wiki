...
Multi-dimensional mapping is a new feature that has been recently introduced to gerefi.  
...
In gerefi you are currently able to activate up to 4 additional compensation maps, each with it's own configurable blend curve.  
...
gerefi allows the following inputs to be used as the input for each of the compensation maps:  
TPS,  
MAP,  
CLT,  
IAT,  
