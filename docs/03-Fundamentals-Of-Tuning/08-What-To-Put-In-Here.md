...
Leave the details of how gerefi works for each feature to the specific pages, when relevant we can link the firmware specific page and visavis, keep this and overview as a nuggets intro area
