...
While the gerefi console is the recommended and officially supported way to update gerefi firmware on supported boards,
other mechanisms exist to flash firmware to board supporting gerefi.  These tools are also useful in odd situations, like
the event of a firmware update/flash failure, or some other firmware corruption issue, such that gerefi console nor
