...
Flex fuel sensors measure the amount of ethanol content in the fuel passing through it. The flex fuel sensor has a pre calibrated signal that is sent from the sensor in a 0-5v voltage indicating which amount of ethanol is present. The gerefi ECU  has the ability to use this data. The signal circuit carries the ethanol percentage via the frequency signal.
